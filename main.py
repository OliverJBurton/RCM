...
if __name__ == '__main__':
    ...
    msc = FullControlMicroscope(no_spectra=20, exposure_time=0.645e-3, save_folder="C:\\Users\\whw29\\Desktop\\Images2", check_stage=False)
    ...
    msc.take_HS_time_series_images(time_increment=300, total_time=14400)
